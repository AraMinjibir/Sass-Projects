...
4. **Other Files:**
    ...
    - Within the container, there was a 'grid-container' (row). There were one colum nested within it. The  column contains  card for customers to rate the Company's products based on their satisfaction.
