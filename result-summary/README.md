...
4. **Other Files:**
    ...
    - Within the container, there was a 'grid-container' (row). There were two colum nested within it. Each column spans to 6 columns from medium devices up to extra-extra-large. The first column the result summary in percent, while the second column contains the breakdown of the result.
